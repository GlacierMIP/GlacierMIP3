...
- additional variables:
       - `year_after_2020`  : new dimension which describes now the "year" after having reached the 2020 state 
       - `volume_rel_2020_%` : scaled and then shifted glacier volume/mass in % relative to 2020 
...
| **Glacier changes and states in past (data from Hugonnet et al. 2021 & Farinotti et al. 2019):** |                                                                             |
